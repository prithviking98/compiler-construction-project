...
typedef enum _gterm {
	...
	TK_RECORDID, TK_WITH, TK_PARAMETERS, TK_END, TK_WHILE, TK_TYPE, TK_MAIN,
	...
	TK_CALL, TK_RECORD, TK_ENDRECORD, TK_ELSE, TK_AND, TK_OR, TK_NOT, TK_LT, TK_LE,
	TK_EQ, TK_GT, TK_GE, TK_NE, SENTINEL, LEX_ERROR
} gterm;
